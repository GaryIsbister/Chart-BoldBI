...
const MIGRATIONS: Migration[] = [
  {
    ...
    sql: `
      ...
      CREATE INDEX idx_action_items_owner ON action_items(owner_side);
      ...
      CREATE TABLE demand_book_imports (
        id TEXT PRIMARY KEY,
      ...
      CREATE TABLE demand_book_entries (
        id TEXT PRIMARY KEY,
        import_id TEXT NOT NULL REFERENCES demand_book_imports(id) ON DELETE CASCADE,
      ...
      CREATE INDEX idx_demand_book_entries_import ON demand_book_entries(import_id);
